...
The problem with functions of a complex variable is that they may not be differentiable! But how do we know if a function is differentiable? We conclude that the differential of a function must be independent of direction. Now this sounds a bit weird so what does it mean? Lets start with the definition of a derivative, which should be familiar.
\begin{equation*}
\frac{df}{dz}
\end{equation*}